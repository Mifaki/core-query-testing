              ...
              <div class="card-body">
                ...
                <div class="row">
                  ...
                  <div class="col-md-3 mb-3">
                    <div class="card bg-light">
                      <div class="card-body text-center">
                        <h5 class="text-success"><?php echo $stats['peak_memory_mb']; ?> MB</h5>
                ...
                <div class="mt-3">
                  <button class="btn btn-outline-info btn-sm" type="button" data-bs-toggle="collapse"
                    data-bs-target="#detailedStats" aria-expanded="false">
                    ...
                    <div class="row">
                      <div class="col-md-6">
                        ...
                        <ul class="list-unstyled">
                          ...
                          <li><strong>Avg Wall Time per Function:</strong> <?php echo $stats['avg_wall_time_ms']; ?> ms
                          </li>
                      ...
                      <div class="col-md-6">
                        ...
                        <ul class="list-unstyled">
                          ...
                          <li><strong>Avg Calls per Function:</strong> <?php echo $stats['avg_calls_per_function']; ?>
                          </li>
                        </ul>
                      </div>
                    </div>
